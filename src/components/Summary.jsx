...
const Summary = ({ filterCategory, totalSpent }) => {
  return (
    <div className="bg-white px-6 py-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center sm:items-end min-w-[220px] transition-all hover:shadow-md">
